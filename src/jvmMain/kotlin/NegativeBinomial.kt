 ...
 */
class FixedNegativeBinomial(theProbSuccess: Double = 0.5, theNumSuccesses: Double = 1.0, name: String? = null) :
    Distribution<FixedNegativeBinomial>(name), DiscreteDistributionIfc, LossFunctionDistributionIfc, GetRVariableIfc {
    ...
    override fun instance(): FixedNegativeBinomial {
        return FixedNegativeBinomial(probOfSuccess, numSuccesses)
    }
    ...
    override fun invCDF(p: Double): Double {
        ...
        return negBinomialInvCDF(p, probOfSuccess, numSuccesses, recursiveAlgorithmFlag).toDouble()
    }
